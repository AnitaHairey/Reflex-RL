...
model_path=xxx/Qwen2.5-7B #set your model path
...
exp_name=bs@${train_batch_size}_n@${rollout_num}_comet_rm@${comet_rm}_cometfree_rm@${comet_free_rm}_reward_metric@${reward_metric}_@${datetime}
